...
from titanic.models.xgb_model import XGBClassifierModel
...
basic_model = XGBClassifierModel(config=config, tags=tags, spark=spark)
...
run_id = mlflow.search_runs(
    experiment_names=["/Users/alexander.mo.dong@gmail.com/titanic-basic"],
